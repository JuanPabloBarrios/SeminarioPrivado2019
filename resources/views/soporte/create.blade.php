                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('soporte.store') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="responsable" type="responsable" class="form-control @error('responsable') is-invalid @enderror" name="responsable" required autocomplete="new-responsable">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="note" type="note" class="form-control @error('note') is-invalid @enderror" name="note" required autocomplete="note">
